...
| IP-05 | ClassLoader-Isolation & Abhängigkeitsgraph (COMPLETED) | Parent-Last-Isolation, host-konfigurierte SDK-Whitelist, Plugin-Abhängigkeitsgraph, `PluginLoader`-Klasse inkl. Force-Load | IP-01, IP-03   |
